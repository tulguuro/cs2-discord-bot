...
_REMINDER_INTROS = [
    "**Өрөө төлөөч ээ, луйварчид минь!** 💸😤",
    "**🎯 Headshot хийхээс өмнө өрөө төл!** Wallhack хайхгүй ш дээ:",
    "**🚨 BREAKING:** Өртэй тоглогчдын нэрс гарлаа — банкны хаалга нээгдсэн:",
    "**💀 Counter-Strike-д өр ороол суудаггүй.** Дансан ороол ор:",
    "**🤡 Yov, өр өшөө л байсаар.** Энэ удаа Faceit rank дээр Silver-руу буцна шдээ:",
    "**👀 Та бүхэн өрөө мартсан уу?** Bot мартдаггүй, бид санаж байна:",
    "**🐍 Уригдаагүй банкны мафи орж ирлээ.** Дараа нь тоглож амжихгүй болно шдээ:",
    "**🎮 AWP-р toxic-yг хошуу баруугаар цохих байтугай** — өрийг төлчих:",
    "**⚠️ Нэг кофе биш ш дээ — өрөө төлбөл л Discord-д үлдэх боломжтой:**",
    "**💸 Хэн өртэй вэ? Дансан мэдэхүй чин олох гэвэл нар хээрэг:**",
    "**🚪 Өрөө төлөхгүй бол rage-quit хийж бол гэх Discord орхих чинь л үлдэнэ:**",
    "**🔪 Knife round ялах гэхээс өрөө төлөх илүү амар.** Шигайнаа:**",
]
